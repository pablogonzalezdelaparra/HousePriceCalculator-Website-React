          ...
          {priceData ? (
            <div className="form-body form-price">
              ...
              <p className="form-price">
                $
                {Number(Math.exp(price)).toLocaleString("en-US", {
                ...
                {moreInfoFlag ? (
                  <Fragment>
                    ...
                    <div
                      ...
                      <div className="more-info-button-text" onClick={() => setMoreInfoFlag(false)}>
                        Cotización regular
                      </div>
                    </div>
                  </Fragment>
                  ...
                  <div
                    className="more-info-button">
                    <div className="more-info-button-text" onClick={() => setMoreInfoFlag(true)}>
                      Cotización avanzada
                    </div>
                  </div>
                )}
